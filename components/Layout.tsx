  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex flex-col md:flex-row transition-colors duration-200">
      ...
      `}>
        ...
        <div className="absolute bottom-0 w-full border-t dark:border-slate-800 bg-gray-50 dark:bg-slate-900/50">
          <div className="p-4">
             ...
             <div className="space-y-1">
                ...
                <button 
                    onClick={toggleTheme}
                    className="w-full flex items-center justify-between p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-slate-800 transition-colors text-sm text-gray-700 dark:text-gray-300"
                >
